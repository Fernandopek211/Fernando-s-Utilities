...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player) => {
    ...
    try {
      ...
      embed.addField("**<:arrow:905708227998670868> Rules Channel:**", `${message.guild.rulesChannel ? `<#${message.guild.rulesChannelId}>`: "<:Error1:913418748105490472> \`No Channel\`"}`, true)
      embed.addField("**<:arrow:905708227998670868> Public Updates Channel:**", `${message.guild.publicUpdatesChannel ? `<#${message.guild.publicUpdatesChannelId}>`: "<:Error1:913418748105490472> \`No Channel\`"}`, true)
      embed.addField("**<:arrow:905708227998670868> AFK Channel:**", `${message.guild.afkChannel ? `<#${message.guild.afkChannelId}>`: "<:Error1:913418748105490472> \`No Channel\`"}`, true)
      ...
      embed.addField(client.la[ls].cmds.info.serverinfo.field12, "<a:Boosted:902094084729081876> \`" + message.guild.premiumSubscriptionCount + "\`", true)
      ...
      if(boosts >= 14){
          embed.addField(`**<:arrow:905708227998670868> Vanity:**`, `${message.guild.vanityURLCode ? `https://discord.gg/${message.guild.vanityURLCode}` : "<:Error1:913418748105490472> No Vanity-Invite"}`)
      }
