...
module.exports = {
    ...
    try{
      ...
      .setAuthor(client.la[ls].cmds.info.botinfo.loading, `https://cdn.discordapp.com/emojis/756773010123522058.gif`, `${emoji.msg.invite}`)]})
      cpuStat.usagePercent(function (e, percent, seconds) {
        ...
        const botinfo = new Discord.MessageEmbed()
            .setAuthor(client.user.tag + " Information", es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL(), `${emoji.msg.addbot}`) 
            ...
            .addField(client.la[ls].cmds.info.botinfo.field4.title, `\`\`\`yml\nName: Fernandopek21#6236\nID: [795885541090132008]\`\`\``, true)
            .addField(client.la[ls].cmds.info.botinfo.field5.title, handlemsg(client.la[ls].cmds.info.botinfo.field5.value, {invitelink: `${emoji.msg.addbot}`}))
