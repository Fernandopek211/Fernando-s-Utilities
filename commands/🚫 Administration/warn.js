    ...
    try {
      ...
      try {
        ...
        warnmember.send({embeds :[new MessageEmbed()
          ...
          .setAuthor(`You've been warned`, `https://media.discordapp.net/attachments/1000804991705034882/1001104156943196170/Fernandos_Utilities.png?width=180&height=180`)
