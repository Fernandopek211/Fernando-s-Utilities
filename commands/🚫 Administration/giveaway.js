        ...
        if (args[0].toLowerCase() === "start") {
            try{
                ...
                let options = {
                    ...
                    bonusEntries: [],
                    messages: {
                        inviteToParticipate: "***React with <a:giveaway1:902096968623472641> to participate!***\n",
                        drawing: "> Ends: {timestamp}\n",
                        hostedBy: "**Hosted by:** {this.hostedBy}",
                        dropMessage: "Be the first to react with <a:giveaway1:902096968623472641>",
                        noWinner: "\n**Giveaway cancelled!**\n> No valid participations. :cry:",
                        endedAt: "Ends at", 
                        giveaway: '<a:giveaway1:902096968623472641> **GIVEAWAY STARTED** <a:giveaway1:902096968623472641>',
                        giveawayEnded: '<a:Tada_Green:946344492892569640> **GIVEAWAY ENDED** <a:Tada_Green:946344492892569640>',
            ...
            client.giveawaysManager.reroll(giveaway.messageId, { winnerCount: !isNaN(args[1]) ? Number(args[1]) : 1})
                ...
                .catch((e) => {
                    if (e.startsWith(`Giveaway with message Id ${giveaway.messageId} is not ended.`)) {
                        ...
                        console.error(e);
                        message.reply({content : '<:Error1:913418748105490472> **An error occured...**```' + String(e.message).substr(0, 1900) + "```"});
                    }
                });
