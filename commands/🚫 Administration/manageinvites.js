...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      .addField("**CURRENT INVITES:**", `<:like:940546772634308618> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)
      ...
      async function menuselection(menu) {
        ...
        await menu?.reply({embeds : [new MessageEmbed()
          ...
          message.reply({embeds : [new MessageEmbed()
            ...
            .addField("\u200b", `<:like:940546772634308618> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)
