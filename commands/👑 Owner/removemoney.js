...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    if (message.author.id !== '795885541090132008') return message.channel.send("<:Error1:913418748105490472> You are not allowed to this command only ``Fernandopek21#6236``");
