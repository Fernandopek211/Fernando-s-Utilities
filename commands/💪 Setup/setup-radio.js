...
module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix) => {
      ...
      try{
        ...
        //send the message of the searching <a:Playing_Audio:908577642968649728> <a:Playing_Audio:908577642968649728> 
        message.reply(
            new Discord.MessageEmbed()
                .setTitle("<a:Playing_Audio:908577642968649728> Setup Complete for Radio Station:  " + song.title)
                .setColor("#7fafe3")
