  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      async function first_layer() {
        ...
        //define the embed
        let MenuEmbed = new MessageEmbed().setColor(es.color).setAuthor('Suggestion System', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/light-bulb_1f4a1.png', 'https://discord.gg/SzP9BdFPYF').setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-ticket"]["variable2"]))
        //send the menu msg
      ...
      client.settings.ensure(message.guild.id, {
        suggest: {
          ...
          denymsg: `<:Error1:913418748105490472> Thank you for the feedback, but we are not interested in this idea at this time.`,
...
/**
 * @INFO
 * Bot Coded by Tomato#6966 | https://discord.gg/SzP9BdFPYF
 * @INFO
