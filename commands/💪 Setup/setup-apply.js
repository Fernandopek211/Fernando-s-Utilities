  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    async function first_layer() {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Application Setup', '<:apply:955033523482427432>', 'https://discord.gg/SzP9BdFPYF'))
    ...
    async function second_layer(SetupNumber, menuoptiondata) {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(SetupNumber + " Apply Setup", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/incoming-envelope_1f4e8.png", "https://discord.gg/SzP9BdFPYF")
                                ...
                                msg.channel.awaitMessages({
                                  ...
                                  if (collected.first().content.toLowerCase() === "no") {
                                    ...
                                    if (!message.guild.me.roles) return message.reply({
                                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable25"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                                        dynamic: true
                                      }))]
                                    })
            ...
            async function setup_without_channel_creation() {
              ...
              await pickmsg.channel.awaitMessages({filter: (m) => m.author.id === cmduser.id,
                  ...
                  if (channel) {
                    ...
                    throw "<:Error1:913418748105490472> ERROR";
                  }
                })
                .catch(e => {
                  errored = e
                    ...
                    message.reply({
                      ...
                      msg.channel.awaitMessages({
                        ...
                        if (collected.first().content.toLowerCase() === "no") {
                          ...
                          if (!message.guild.me.roles) return message.reply({
                            embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable58"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                              dynamic: true
                            }))]
                          })
        ...
        case "acceptrole": {
          message.reply({
            ...
            msg.channel.awaitMessages({
              ...
              if (!message.guild.me.roles) return message.reply({
                embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable70"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                  dynamic: true
                }))]
              })
              ...
              if (guildrole.rawPosition <= botrole.rawPosition) {
                ...
                return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable71"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
              }
          ...
          case "setrole": {
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable81"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable82"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
          ...
          case "setrole": {
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable100"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable101"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
          ...
          case "setrole": {
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable119"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable120"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
          ...
          case "setrole": {
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable140"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable141"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
          ...
          case "setrole": {
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable161"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable162"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
        ...
        case "temprole":
          message.reply({
            ...
            msg.channel.awaitMessages({
              ...
              if (!message.guild.me.roles) return message.reply({
                embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable183"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                  dynamic: true
                }))]
              })
              ...
              if (guildrole.rawPosition <= botrole.rawPosition) {
                ...
                return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable184"])).setAuthor("<:Error1:913418748105490472> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
              }
