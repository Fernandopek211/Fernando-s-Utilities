  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      case `addcurrenttrack`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:success:902091899802910760> Added ${track.title} onto the Queue \`${Name}\``.substr(0, 256))
      ...
      case `removesong`: {
        ...
        //return susccess message
        return message.reply({embeds :[new MessageEmbed()
          .setTitle(`<a:success:902091899802910760> Deleted ${deletetrack.title} of the Queue \`${Name}\``.substr(0, 256))
      ...
      case `mix`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:success:902091899802910760> Shuffled ${newtracks.length} Tracks of the Queue \`${Name}\``.substr(0, 256))
      ...
      case `removeduplicates`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:success:902091899802910760> Removed ${counter} Tracks from the Queue \`${Name}\``.substr(0, 256))
