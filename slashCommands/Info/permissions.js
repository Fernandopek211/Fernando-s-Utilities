...
module.exports = {
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    if(!user) user = member.user;
        ...
        embeduserinfo.setAuthor(handlemsg(client.la[ls].cmds.info.permissions.from, {usertag: member.user.tag}), member.user.displayAvatarURL({ dynamic: true }), "https://discord.com/api/oauth2/authorize?client_id=941305934809010186&permissions=8&scope=bot%20applications.commands")
