  ...
  client.on("guildMemberAdd", async mem => {
    ...
    async function welcome(member) {
      ...
      if (invite && inviter) {
        ...
        invitemessage = `Invited by ${inviter.tag ? `**${inviter.tag}**` : `<@${inviter.id}>`}\n<:like:940546772634308618> **${realinvites} Invite${realinvites == 1 ? "" : "s"}**\n[<:Joined:902086085130223657> ${invites} Joins | <:Leave:902086070169124875> ${leaves} Leaves | <:Error1:913418748105490472> ${fake} Fakes]`;
      } 
      else if(invite){
