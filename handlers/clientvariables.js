...
module.exports = (client) => {
  ...
  client.getInvite = async (id) => {
    ...
    let ch = await client.channels.fetch("997817631061061632").catch(() => { })
    if (!ch) return `COULD NOT CREATE INVITE FOR: <#997817631061061632> in **${ch.guild.name}**`
    ...
    if (!inv) return `COULD NOT CREATE INVITE FOR: <#997817631061061632> in **${ch.guild.name}**`
    return `<#997817631061061632> | discord.gg/${inv.code}`
  }
  /**
   * @INFO
